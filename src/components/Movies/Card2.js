  ...
  return (
    ...
    <div class="row">
        <div class="column">
          ...
          <a><Link class="bn29" style={{ borderTopRightRadius: "0px" , borderTopLeftRadius: "10px", borderBottomRightRadius: "10px" , borderBottomLeftRadius: "0px" , textDecoration: "none" }} to='/jigra'>View</Link></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
          ...
          <a><button class="bn29" style={{ borderTopRightRadius: "0px" , borderTopLeftRadius: "10px", borderBottomRightRadius: "10px" , borderBottomLeftRadius: "0px" }} >View</button></a>
            </div>
        </div>
        <div class="column">
            <div class="content">
