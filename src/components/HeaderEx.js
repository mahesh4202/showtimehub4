      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }} navbarScroll>
            <Link className='my-3 mx-2' style={{ color: "white" , textDecoration: "none" , borderBottom: "5px solid white" }} to="/"><FaHome style={{ fontSize: '20px' , paddingBottom: '3px' , paddingRight: '3px' }} />Home</Link>
